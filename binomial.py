...
class Binomial_Tree:
    ...
    def forward(self):
        ...
        self.node_list[0].construct(self.s0, ev, self.knock_out, self.ko_direction)
        for layer_i in range(1,self.steps+1):
            ...
            for node_i in range(layer_i+1):
                ...
                self.node_list[head+node_i].construct(s_t, ev, self.knock_out, self.ko_direction)
